...
def show_market_regime():
    ...
    # Plot regime changes with smaller figure size
    fig, ax = plt.subplots(figsize=(10, 4))  # Adjust the height here
    data_df['regime'].plot(ax=ax, marker='o', linestyle='-')

    # Set regime labels
    regime_labels = ['Warming', 'Perfection', 'Cooling', 'Overheating']
    ax.set_yticks(range(4))
    ax.set_yticklabels(regime_labels)
    ax.set_title("Regime Changes Over Time")
